...
steps:
  ...
  - text: >-
      מוציאים את הנורה הישנה. מסובבים נגד כיוון השעון (לבסיס הברגה סטנדרטי) עד
      שהיא משתחררת. לנורות עם בסיס בயונט, לוחצים קלות פנימה ומסובבים.
  ...
  - text: >-
      מכניסים את הנורה החדשה. מסובבים עם כיוון השעון עד שהיא יושבת יציב — בלי
      להדק יותר מדי.
