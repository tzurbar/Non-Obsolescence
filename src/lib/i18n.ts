...
export const ui = {
  en: {
    ...
    submit: {
      ...
      categoryNotListed: '— Not listed yet —',
      newCategoryPlaceholder: 'Describe the category, e.g. Kitchen Appliances',
      categoryRequiredError: 'Please choose a category, or describe a new one.',
      ...
      toolPlaceholder: 'e.g. Screwdriver',
      addTool: '+ Add tool',
      partLinksLabel: 'Part links',
      videoLinksLabel: 'Video links',
      addPartLink: '+ Add part link',
      ...
      authorContactLabel: 'Email or contact (optional)',
      authorContactPlaceholder: 'In case we have questions about your submission',
  ...
  he: {
    ...
    submit: {
      ...
      categorySelectPlaceholder: '— בחרו קטגוריה —',
      categorySearchPlaceholder: 'חיפוש קטגוריות…',
      categoryNotListed: '— לא ברשימה —',
      newCategoryPlaceholder: 'תארו את הקטגוריה, לדוגמה: מכשירי חשמל למטבח',
      categoryRequiredError: 'בחרו קטגוריה, או תארו קטגוריה חדשה.',
      ...
      toolPlaceholder: 'לדוגמה: מברג',
      addTool: '+ הוספת כלי',
      partLinksLabel: 'קישורים לחלקים',
      videoLinksLabel: 'קישורים לסרטונים',
      addPartLink: '+ הוספת קישור לחלק',
      addVideoLink: '+ הוספת קישור לסרטון',
      ...
      authorContactLabel: 'אימייל או דרך יצירת קשר (אופציונלי)',
      authorContactPlaceholder: 'למקרה שיהיו לנו שאלות לגבי ההגשה',
  ...
  ar: {
    ...
    submit: {
      ...
      categorySearchPlaceholder: 'ابحث عن الفئات…',
      categoryNotListed: '— غير مدرجة بعد —',
      newCategoryPlaceholder: 'صف الفئة، مثال: أجهزة المطبخ',
      categoryRequiredError: 'يرجى اختيار فئة، أو وصف فئة جديدة.',
      ...
      toolPlaceholder: 'مثال: مفك براغي',
      addTool: '+ إضافة أداة',
      partLinksLabel: 'روابط القطع',
      videoLinksLabel: 'روابط الفيديو',
      addPartLink: '+ إضافة رابط قطعة',
      addVideoLink: '+ إضافة رابط فيديو',
      linkNamePlaceholder: 'اسم الرابط',
      linkUrlPlaceholder: 'https://...',
      ...
      authorContactLabel: 'البريد الإلكتروني أو وسيلة تواصل (اختياري)',
      authorContactPlaceholder: 'في حال كانت لدينا أسئلة حول إرسالك',
  ...
  es: {
    ...
    submit: {
      ...
      categoryNotListed: '— Aún no está en la lista —',
      newCategoryPlaceholder: 'Describe la categoría, p. ej. Electrodomésticos de cocina',
      categoryRequiredError: 'Elige una categoría, o describe una nueva.',
      ...
      authorContactLabel: 'Correo o contacto (opcional)',
      authorContactPlaceholder: 'Por si tenemos preguntas sobre tu envío',
  ...
  pt: {
    ...
    submit: {
      ...
      categorySearchPlaceholder: 'Buscar categorias…',
      categoryNotListed: '— Ainda não está na lista —',
      newCategoryPlaceholder: 'Descreva a categoria, ex.: Eletrodomésticos de cozinha',
      categoryRequiredError: 'Escolha uma categoria, ou descreva uma nova.',
      ...
      toolPlaceholder: 'ex.: Chave de fenda',
      addTool: '+ Adicionar ferramenta',
      partLinksLabel: 'Links de peças',
      videoLinksLabel: 'Links de vídeo',
      addPartLink: '+ Adicionar link de peça',
      addVideoLink: '+ Adicionar link de vídeo',
      linkNamePlaceholder: 'Nome do link',
      linkUrlPlaceholder: 'https://...',
      ...
      authorContactLabel: 'E-mail ou contato (opcional)',
      authorContactPlaceholder: 'Caso tenhamos dúvidas sobre seu envio',
