...
score: 6.5
summary: >-
  Reparabilidade média. A bateria e o armazenamento são substituíveis pelo
  usuário com ferramentas padrão, mas o conjunto da tela requer ferramentas
  específicas para remoção de adesivos e as trocas de tela não são vendidas para
  consumidores.
sources:
